...
# All source dirs must be patched to avoid reading real data
...
_PATCH_PLASMA_DIR = patch("tokendroid.plasma_parser.PLASMA_SESSIONS_DIR", Path("/nonexistent"))
...
class TestNeedsSync:
    def test_empty_dir(self, conn):
        with _PATCH_FACTORY_DIR, _PATCH_PI_DIR, _PATCH_PLASMA_DIR:
